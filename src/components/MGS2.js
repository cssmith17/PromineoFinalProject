...
<img className="rounded-t-lg mx-auto" src={VideoGamesData[1].poster} alt="" />
</div>
...
<h5 className="text-center mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">{VideoGamesData[1].title}</h5>
<div className="col-start-1">
<p className="text-center bg-green-100 text-lg text-green-800 font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">MetaCritic: {VideoGamesData[1].ms}</p>
<p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{VideoGamesData[1].plot}</p>
        </div>
        <div className="col-start-2">
        <img className="rounded-t-lg" src={VideoGamesData[1].logo} />
        </div>
        </div>
     </div>
